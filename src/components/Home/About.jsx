...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Received a stage 1 paint correction, 4 year ceramic coating, wheel and window coating. Easy recommendation. Really impressed with the final finish. Any car can look like new with Max giving it his full care & attention.",
    name: "A Cool (Skid)",
  },
